...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    >
      <Sun className="h-4 w-4 text-foreground opacity-0 transition-opacity group-data-[state=unchecked]:opacity-100" />
      <Moon className="absolute h-4 w-4 text-foreground opacity-0 transition-opacity group-data-[state=checked]:opacity-100" />
    </SwitchPrimitives.Thumb>
  </SwitchPrimitives.Root>
))
